...
async fn main() {
    ...
    match cli.command {
        Commands::Register { token, price } => {
            ...
            // Create the register action and wrap it in a blob transaction
            ...
            let register_tx = BlobTransaction {
                ...
                blobs: vec![register_action.as_blob("hyle".into(), None, None)],
            };

            // Send the blob transaction
            let res = client.send_tx_blob(&register_tx).await.unwrap();
